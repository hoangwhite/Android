...
import com.ctk43.doancoso.View.Activity.LoginActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Thực hiện đăng xuất ở đây (xóa thông tin đăng nhập nếu có)

                // Khởi tạo Intent để quay lại LoginActivity
                Intent loginIntent = new Intent(getActivity(), LoginActivity.class);

                // Xóa các hoạt động khỏi ngăn xếp để ngăn người dùng quay lại fragment ProfleFragment sau khi đăng xuất
                loginIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                loginIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                loginIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                // Khởi động hoạt động LoginActivity và kết thúc hoạt động hiện tại
